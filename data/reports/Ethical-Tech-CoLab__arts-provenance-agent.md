# Ethical-Tech-CoLab/arts-provenance-agent
...
- **Tool-using agents** — `DPP-Paper.md:772`
- **Memory/retrieval layer** — `DPP-Paper.md:946`
...
`region`, `party`, `child`, `age`, `household`, `elderly`, `vulnerability`, `disabled`

## Models referenced

- `claude-joseph` (1 mentions)
