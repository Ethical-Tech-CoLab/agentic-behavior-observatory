...
[https://github.com/mesa/mesa](https://github.com/mesa/mesa) · ★3806 · Python · analysed 2026-08-25

## Axis scores

- **Agent-based simulation** `██████····` 63/100
- **Synthetic data generation** `··········` 0/100
- **LLM-based behavioural modelling** `█·········` 6/100
- **Reinforcement learning / policy search** `██········` 18/100
- **Evaluation & validation rigour** `███████···` 69/100

Agentic-behaviour relevance: **47/100** (primary axis: Agent-based simulation)

## Evidence

### Agent-based simulation

- **Mesa agent-based modelling framework** — `dependencies`
